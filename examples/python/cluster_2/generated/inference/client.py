...
class InferenceClient:
    ...
    async def infer(self, request: InferenceRequest) -> InferenceResponse:
        ...
        # Call RPC method 'infer'
        response_bytes = await self._client.call('infer', request_bytes)
    ...
    async def generate(self, request_stream: AsyncIterable[InferenceRequest]) -> AsyncIterator[InferenceResponse]:
        ...
        # Call streaming RPC method 'generate'
        response_stream = await self._client.call_streaming('generate', request_list)
