...
class DirectorRegistryClient:
    """Type-safe client for DirectorRegistry service
    ...
    async def connect(
        ...
        """Connect to DirectorRegistry server
        ...
        Returns:
            DirectorRegistryClient: Connected client instance
        """
        ...
        return DirectorRegistryClient(client)
    ...
    async def get_worker(self, request: GetWorkerRequest) -> GetWorkerResponse:
        ...
        # Call RPC method 'DirectorRegistry.get_worker'
        response_bytes = await self._client.call('DirectorRegistry.get_worker', request_bytes)
